...
public class EC3PacketDispatcher implements IMessageHandler<PacketNBT,IMessage>{
	...
	public void handleMessage(PacketNBT message, MessageContext ctx) {
		...
		case 3: {
			TileEntity tile = EssentialCraftCore.proxy.getClientPlayer().worldObj.getTileEntity(new BlockPos(message.theTag.getInteger("x"), message.theTag.getInteger("y"), message.theTag.getInteger("z")));
		...
		case 5: {
			...
			TileEntity tile = requester.worldObj.getTileEntity(new BlockPos(message.theTag.getInteger("px"), message.theTag.getInteger("py"), message.theTag.getInteger("pz")));
			if(tile != null && tile instanceof TileNewMIM) {
				...
				if(!message.theTag.getBoolean("craft")) {
					...
					TileEntity t = requester.worldObj.getTileEntity(new BlockPos(message.theTag.getInteger("x"), message.theTag.getInteger("y"), message.theTag.getInteger("z")));
