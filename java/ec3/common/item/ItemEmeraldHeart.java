...
public class ItemEmeraldHeart extends ItemStoresMRUInNBT implements IModelRegisterer {
	...
	{
		if(p_77654_3_ instanceof EntityPlayer && (ECUtils.tryToDecreaseMRUInStorage((EntityPlayer)p_77654_3_, -500) || this.setMRU(p_77654_1_, -500)))
		{
			p_77654_3_.heal(10);
		}
		return p_77654_1_;
