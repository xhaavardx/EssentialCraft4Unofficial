		...
		if(stack.getTagCompound() == null)
		{
			...
			if(tile != null)
			{
				if(tile instanceof TileMagicalMirror)
				{
					...
					player.addChatMessage(new TextComponentString("Mirror linked to the wand!").setStyle(new Style().setColor(TextFormatting.GREEN)));
			...
			{if(tile instanceof IInventory)
			{
				...
				if(distance <= TileMagicalMirror.cfgMaxDistance)
				{
					...
					if(tile1 != null && tile1 instanceof TileMagicalMirror)
					{
						...
						player.addChatMessage(new TextComponentString("Mirror linked to the inventory!").setStyle(new Style().setColor(TextFormatting.GREEN)));
