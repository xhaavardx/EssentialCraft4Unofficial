...
public class ItemCharm extends ItemStoresMRUInNBT implements IBauble, IModelRegisterer {
	...
	public void updateFire(EntityPlayer e, ItemStack s) {
		if(e.isBurning() && !e.isPotionActive(MobEffects.FIRE_RESISTANCE) && (ECUtils.tryToDecreaseMRUInStorage(e, -50) || setMRU(s, -50))) {
			e.extinguish();
			e.worldObj.playSound(e, e.posX, e.posY, e.posZ, SoundEvents.ENTITY_GENERIC_EXTINGUISH_FIRE, SoundCategory.PLAYERS, 1, 1);
		}
	}
	...
	public void updateWater(EntityPlayer e, ItemStack s) {
		if(e.getAir() < 10 && e.isInWater() && (ECUtils.tryToDecreaseMRUInStorage(e, -100) || setMRU(s, -100))) {
			e.setAir(100);
			e.worldObj.playSound(e, e.posX, e.posY, e.posZ, SoundEvents.ENTITY_PLAYER_BREATH, SoundCategory.PLAYERS, 1, 1);
		}
	}
	...
	public void updateAir(EntityPlayer e, ItemStack s) {
		if(e.isSprinting() && !e.isPotionActive(MobEffects.SPEED) && (ECUtils.tryToDecreaseMRUInStorage(e, -10) || setMRU(s, -10))) {
			...
			e.worldObj.playSound(e, e.posX, e.posY, e.posZ, SoundEvents.ENTITY_PLAYER_BREATH, SoundCategory.PLAYERS, 1, .01F);
		}
	}
	...
	public void updateSteam(EntityPlayer e, ItemStack s) {
		if(e.getHealth() < 5 && !e.isPotionActive(MobEffects.SPEED) && (ECUtils.tryToDecreaseMRUInStorage(e, -200) || setMRU(s, -200))) {
			...
			e.worldObj.playSound(e, e.posX, e.posY, e.posZ, SoundEvents.ENTITY_PLAYER_BREATH, SoundCategory.PLAYERS, 1, .01F);
			e.worldObj.playSound(e, e.posX, e.posY, e.posZ, SoundEvents.ENTITY_GENERIC_EXTINGUISH_FIRE, SoundCategory.PLAYERS, 1, .01F);
		}
	}

	public void updateMagma(EntityPlayer e, ItemStack s) {
		Material m = e.worldObj.getBlockState(new BlockPos((int)e.posX-1, (int)e.posY-1, (int)e.posZ)).getMaterial();
		Material m1 = e.worldObj.getBlockState(new BlockPos((int)e.posX-1, (int)e.posY, (int)e.posZ)).getMaterial();
		if((m == Material.LAVA || m1 == Material.LAVA) && !e.isPotionActive(MobEffects.FIRE_RESISTANCE) && (ECUtils.tryToDecreaseMRUInStorage(e, -100) || setMRU(s, -100))) {
			...
			e.worldObj.playSound(e, e.posX, e.posY, e.posZ, SoundEvents.BLOCK_LAVA_AMBIENT, SoundCategory.PLAYERS, 1, 10F);
		}
	}

	public void updateLightning(EntityPlayer e, ItemStack s) {
		if(e.worldObj.isThundering()&& !e.isPotionActive(MobEffects.STRENGTH) && (ECUtils.tryToDecreaseMRUInStorage(e, -100) || setMRU(s, -100))) {
			e.addPotionEffect(new PotionEffect(MobEffects.FIRE_RESISTANCE, 100, 0));
			...
			e.worldObj.playSound(e, e.posX, e.posY, e.posZ, SoundEvents.ENTITY_LIGHTNING_THUNDER, SoundCategory.PLAYERS, 1, 1F);
		}
	}
	...
	public void updateLife(EntityPlayer e, ItemStack s) {
		if(e.getHealth() < 5 && !e.isPotionActive(MobEffects.REGENERATION) && (ECUtils.tryToDecreaseMRUInStorage(e, -200) || setMRU(s, -200))) {
			...
			e.worldObj.playSound(e, e.posX, e.posY, e.posZ, SoundEvents.ENTITY_EXPERIENCE_ORB_PICKUP, SoundCategory.PLAYERS, 1,  10F);
		}
	...
	public void updateRain(EntityPlayer e, ItemStack s) {
		if(e.worldObj.isRaining() && !e.isPotionActive(MobEffects.HASTE) && (ECUtils.tryToDecreaseMRUInStorage(e, -50) || setMRU(s, -50))) {
			...
			e.worldObj.playSound(e, e.posX, e.posY, e.posZ, SoundEvents.ENTITY_PLAYER_SPLASH, SoundCategory.PLAYERS, 1, 1F);
		}
	}
