...
public class BlockReactorSupport extends Block implements IModelRegisterer {
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess world, BlockPos pos) {
		...
		TileEntity ste = world instanceof ChunkCache ? ((ChunkCache)world).func_190300_a(pos.south(), Chunk.EnumCreateEntityType.CHECK) : world.getTileEntity(pos.south());
		TileEntity ete = world instanceof ChunkCache ? ((ChunkCache)world).func_190300_a(pos.east(), Chunk.EnumCreateEntityType.CHECK) : world.getTileEntity(pos.east());
		TileEntity nte = world instanceof ChunkCache ? ((ChunkCache)world).func_190300_a(pos.north(), Chunk.EnumCreateEntityType.CHECK) : world.getTileEntity(pos.north());
		TileEntity wte = world instanceof ChunkCache ? ((ChunkCache)world).func_190300_a(pos.west(), Chunk.EnumCreateEntityType.CHECK) : world.getTileEntity(pos.west());
