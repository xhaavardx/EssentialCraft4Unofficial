...
public class GuiCraftingFrame extends GuiContainer{
	...
	{
		if(!this.crafter.filterStack.isItemEqual(mc.thePlayer.getHeldItemMainhand()))
			this.crafter.filterStack = mc.thePlayer.getHeldItemMainhand();
		if(!ItemStack.areItemStackTagsEqual(this.crafter.filterStack, mc.thePlayer.getHeldItemMainhand()))
			this.crafter.filterStack = mc.thePlayer.getHeldItemMainhand();
