...
public class ECUtils {
	...
	public static void sendChatMessageToAllPlayersInDim(int dimID,String msg)
	{
		...
		{
			EntityPlayer player = FMLCommonHandler.instance().getMinecraftServerInstance().getPlayerList().getPlayerByUsername(FMLCommonHandler.instance().getMinecraftServerInstance().getAllUsernames()[i]);
