	    ...
	    public void drawButton(Minecraft p_146112_1_, int p_146112_2_, int p_146112_3_)
	    {
	        if (this.visible)
	        {
	            ...
	            if(!unicode)
	            	...
	            	this.drawCenteredString(fontrenderer, this.displayString, !unicode ? (this.xPosition + this.width / 2)*2 : MathHelper.floor((this.xPosition + this.width / 2)/0.95F), !unicode ? (this.yPosition + (this.height - 8) / 2)*2+4 : MathHelper.floor((this.yPosition + (this.height - 8) / 2)/0.95F), l);
	            if(!unicode)
