...
public class ChunkProviderFirstWorld extends ChunkProviderOverworld {
	...
	public void populate(int p_73153_2_, int p_73153_3_)
	{
		...
		try
		{
			this.town.generateStructure(this.worldObj, this.rand, new ChunkPos(p_73153_2_, p_73153_3_));
			this.shafts.generateStructure(this.worldObj, this.rand, new ChunkPos(p_73153_2_, p_73153_3_));
		}
		catch(Exception e)
		{
			return;
		...
		if(y > 6 && y < 32 && this.rand.nextFloat() < 0.1F)
		{
			...
			(new WorldGenOldCatacombs()).generate(this.worldObj, this.rand, new BlockPos(l1, y, j2));
		}
	...
	{
		instance = this;
		this.town.generate(this.worldObj, p_73154_1_, p_73154_2_, new ChunkPrimer());
		this.shafts.generate(this.worldObj, p_73154_1_, p_73154_2_, new ChunkPrimer());
		return super.provideChunk(p_73154_1_, p_73154_2_);
	}

	public void recreateStructures(Chunk chunk, int p_82695_1_, int p_82695_2_)
	{
		this.town.generate(this.worldObj, p_82695_1_, p_82695_2_, new ChunkPrimer());
		this.shafts.generate(this.worldObj, p_82695_1_, p_82695_2_, new ChunkPrimer());
	}
}
