...
public class ItemWindPickaxe extends ItemPickaxe_Mod {
	...
	public boolean hitEntity(ItemStack weapon, EntityLivingBase attacked, EntityLivingBase attacker)
	{
		...
		if(attacker instanceof EntityPlayer)
		{
			...
			if(!p.worldObj.isRemote && currentTool != null && currentTool.getItem() instanceof ItemTool && ItemTool.class.cast(currentTool.getItem()).getToolMaterial() == ItemsCore.windElemental)
			{
