...
public class GuiWeaponBench extends GuiCommon {
	...
	{
		MiscUtils.handleButtonPress(par1GuiButton.id, this.getClass(), GuiButton.class, Minecraft.getMinecraft().thePlayer, this.genericTile.getPos().getX(), this.genericTile.getPos().getY(), this.genericTile.getPos().getZ());
	}
