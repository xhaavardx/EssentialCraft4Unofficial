...
public class ItemArmorMod extends ItemArmor implements /*IRepairable, IVisDiscountGear, IRevealer, IGoggles,*/ ISpecialArmor, IItemRequiresMRU, IModelRegisterer {
	...
	public Multimap<String,AttributeModifier> getAttributeModifiers(EntityEquipmentSlot s, ItemStack stack)
	{
		...
		if(this == ItemsCore.magicArmorItems[5] && s == EntityEquipmentSlot.CHEST)
			mods.put(SharedMonsterAttributes.MAX_HEALTH.getAttributeUnlocalizedName(), new AttributeModifier(UUID.fromString("1bca943c-3cf5-42cc-a3df-2ed994ae0000"), "hp", 20D, 0));

		if(this == ItemsCore.magicArmorItems[7] && s == EntityEquipmentSlot.FEET)
			mods.put(SharedMonsterAttributes.MOVEMENT_SPEED.getAttributeUnlocalizedName(), new AttributeModifier(UUID.fromString("1bca943c-3cf5-42cc-a3df-2ed994ae0000"), "movespeed", 0.075D, 0));

		if(this == ItemsCore.magicArmorItems[9] && s == EntityEquipmentSlot.CHEST)
			mods.put(SharedMonsterAttributes.MAX_HEALTH.getAttributeUnlocalizedName(), new AttributeModifier(UUID.fromString("1bca943c-3cf5-42cc-a3df-2ed994ae0000"), "hp", 30D, 0));

		if(this == ItemsCore.magicArmorItems[11] && s == EntityEquipmentSlot.FEET)
			mods.put(SharedMonsterAttributes.MOVEMENT_SPEED.getAttributeUnlocalizedName(), new AttributeModifier(UUID.fromString("1bca943c-3cf5-42cc-a3df-2ed994ae0000"), "movespeed", 0.1D, 0));
