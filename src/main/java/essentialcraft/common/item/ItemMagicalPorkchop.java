...
public class ItemMagicalPorkchop extends ItemMRUGeneric implements IModelRegisterer {
	...
	{
		if(p_77654_3_ instanceof EntityPlayer && ECUtils.playerUseMRU((EntityPlayer)p_77654_3_, p_77654_1_, 1500))
		{
