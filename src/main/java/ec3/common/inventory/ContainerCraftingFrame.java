...
public class ContainerCraftingFrame extends Container {
	...
	public static class SlotFake extends Slot {
		...
		public boolean canTakeStack(EntityPlayer player) {
			...
			ItemStack result = CraftingManager.getInstance().findMatchingRecipe(crafting, player.getEntityWorld());
			...
			if(slotNumber != 9) {
				...
				result = CraftingManager.getInstance().findMatchingRecipe(crafting, player.getEntityWorld());
								...
								if(rec instanceof ShapelessOreRecipe) {
									...
									if(srec.getInput().size() > i) {
										if(srec.getInput().get(i) != null) {
											...
											parent.inventory.setInventorySlotContents(i, (ItemStack)ust.possibleStacks.get(player.getEntityWorld().rand.nextInt(ust.possibleStacks.size())));
										}
										else
											parent.inventory.setInventorySlotContents(i, null);
									}
