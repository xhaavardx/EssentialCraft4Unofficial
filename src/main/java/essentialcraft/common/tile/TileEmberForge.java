...
public class TileEmberForge extends TileMRUGeneric {
	...
	public void update() {
		...
		if(isStructureCorrect()) {
			...
			if(!l_0.isEmpty() && l_0.get(0).getItem().getItem() instanceof ItemEmber)
				ember_0 = l_0.get(0);
			...
			if(!l_1.isEmpty() && l_1.get(0).getItem().getItem() instanceof ItemEmber)
				ember_1 = l_1.get(0);
			...
			if(!l_2.isEmpty() && l_2.get(0).getItem().getItem() instanceof ItemEmber)
				ember_2 = l_2.get(0);
			...
			if(!l_3.isEmpty() && l_3.get(0).getItem().getItem() instanceof ItemEmber)
				ember_3 = l_3.get(0);
			...
			if(!l_4.isEmpty() && l_4.get(0).getItem().getItem() instanceof ItemElementalFocus)
				focus_0 = l_4.get(0);
			...
			if(!l_41.isEmpty() && l_41.get(0).getItem().getItem() instanceof ItemElementalFocus)
				focus_1 = l_41.get(0);
			...
			if(!l_411.isEmpty() && l_411.get(0).getItem().getItem() instanceof ItemElementalFocus)
				focus_2 = l_411.get(0);
			...
			if(!l_4111.isEmpty() && l_4111.get(0).getItem().getItem() instanceof ItemElementalFocus)
