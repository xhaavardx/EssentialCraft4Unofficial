...
public class WorldProviderFirstWorld extends WorldProvider {
	...
	{
		this.biomeProvider = new WorldChunkManager_FirstWorld(this.worldObj.getWorldInfo());
	...
	{
		return new ChunkProviderFirstWorld(this.worldObj, this.worldObj.getSeed(), true, this.worldObj.getWorldInfo().getGeneratorOptions());
	}
}
