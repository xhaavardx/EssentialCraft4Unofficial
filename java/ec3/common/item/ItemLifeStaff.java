	...
	public boolean onLeftClickEntity(ItemStack stack, EntityPlayer player, Entity entity)
	{
		if(entity instanceof EntityZombie)
		{
			...
			if(e.isVillager() && (ECUtils.tryToDecreaseMRUInStorage(player, -500) || this.setMRU(stack, -500)) && !e.worldObj.isRemote)
			{
				...
				entityvillager.onInitialSpawn(entity.worldObj.getDifficultyForLocation(entity.getPosition()), (IEntityLivingData)null);
				if (e.isChild())
				{
				...
				e.worldObj.playEvent((EntityPlayer)null, 1017, e.getPosition(), 0);
			}
			return true;
		}
