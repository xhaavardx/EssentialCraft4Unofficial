...
public class ResearchRegistry {
	...
	public static void registerBasicCategory()
	{
		...
		.apendDiscovery(
				...
				.apendPage(
						...
						.setText(I18n.translateToLocal("ec3.page.book_0.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.book_1")
						.setRecipe(ECUtils.findRecipeByIS(book,2))
						.setText(I18n.translateToLocal("ec3.page.book_1.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.book_2")
						.setText(I18n.translateToLocal("ec3.page.book_2.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.book_3")
						.setText(I18n.translateToLocal("ec3.page.book_3.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.book_4")
						.setText(I18n.translateToLocal("ec3.page.book_4.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.book_5")
						.setText(I18n.translateToLocal("ec3.page.book_5.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.book_6")
						.setText(I18n.translateToLocal("ec3.page.book_6.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.book_7")
						.setText(I18n.translateToLocal("ec3.page.book_7.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.book_8")
						.setText(I18n.translateToLocal("ec3.page.book_8.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.book_9")
						.setText(I18n.translateToLocal("ec3.page.book_9.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.book_10")
						.setText(I18n.translateToLocal("ec3.page.book_10.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.book_11")
						.setText(I18n.translateToLocal("ec3.page.book_11.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.book_12")
						.setText(I18n.translateToLocal("ec3.page.book_12.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.book_13")
						.setText(I18n.translateToLocal("ec3.page.book_13.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.book_14")
						.setText(I18n.translateToLocal("ec3.page.book_14.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.book_15")
						.setText(I18n.translateToLocal("ec3.page.book_15.txt"))
						.setRecipe(
		...
		.apendDiscovery(
				...
				.apendPage(
						...
						.setText(I18n.translateToLocal("ec3.page.wind_3.txt"))
						)
				.apendPage(
		...
		.apendDiscovery(
				...
				.apendPage(
						...
						.setText(I18n.translateToLocal("ec3.page.drops_0.txt"))
						)
				.apendPage(
						...
						.setText(I18n.translateToLocal("ec3.page.drops_1.txt"))
						)
				.apendPage(
						...
						.setText(I18n.translateToLocal("ec3.page.drops_2.txt"))
						)
				.apendPage(
						...
						.setText(I18n.translateToLocal("ec3.page.drops_3.txt"))
						)
				.apendPage(
						...
						.setText(I18n.translateToLocal("ec3.page.drops_4.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.drops_11")
						.setText(I18n.translateToLocal("ec3.page.drops_11.txt"))
				...
				.apendPage(
						...
						.setText(I18n.translateToLocal("ec3.page.drops_5.txt"))
						)
				.apendPage(
		...
		.apendDiscovery(
				...
				.apendPage(
						...
						.setText(I18n.translateToLocal("ec3.page.miscCrafts_0.txt"))
						)
				.apendPage(
		...
		.apendDiscovery(
				...
				.apendPage(
						...
						.setText(I18n.translateToLocal("ec3.page.mru_0.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.mru_1")
						.setText(I18n.translateToLocal("ec3.page.mru_1.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.mru_2")
						.setText(I18n.translateToLocal("ec3.page.mru_2.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.mru_3")
						.setImg(new ResourceLocation("essentialcraft","textures/special/bookIcons/mru_lowest.png"))
						.setText(I18n.translateToLocal("ec3.page.mru_3.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.mru_4")
						.setText(I18n.translateToLocal("ec3.page.mru_4.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.mru_5")
						.setText(I18n.translateToLocal("ec3.page.mru_5.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.mru_6")
						.setText(I18n.translateToLocal("ec3.page.mru_6.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.mru_7")
						.setText(I18n.translateToLocal("ec3.page.mru_7.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.mru_8")
						.setText(I18n.translateToLocal("ec3.page.mru_8.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.mru_9")
						.setText(I18n.translateToLocal("ec3.page.mru_9.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.mru_10")
						.setText(I18n.translateToLocal("ec3.page.mru_10.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.mru_11")
						.setText(I18n.translateToLocal("ec3.page.mru_11.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.mru_12")
						.setImg(new ResourceLocation("essentialcraft","textures/special/bookIcons/mru_pressence.png"))
						.setText(I18n.translateToLocal("ec3.page.mru_12.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.mru_13")
						.setText(I18n.translateToLocal("ec3.page.mru_13.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.mru_14")
						.setText(I18n.translateToLocal("ec3.page.mru_14.txt"))
				...
				.apendPage(
						...
						.setText(I18n.translateToLocal("ec3.page.mru_15.txt"))
						)
				.apendPage(
		...
		.apendDiscovery(
				...
				.apendPage(
						...
						.setText(I18n.translateToLocal("ec3.page.soulStone_0.txt"))
						)
				.apendPage(
						...
						.setText(I18n.translateToLocal("ec3.page.soulStone_1.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.soulStone_2")
						.setImg(new ResourceLocation("essentialcraft","textures/special/bookIcons/soulStone.png"))
						.setText(I18n.translateToLocal("ec3.page.soulStone_2.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.soulStone_3")
						.setText(I18n.translateToLocal("ec3.page.soulStone_3.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.soulStone_43")
						.setText(I18n.translateToLocal("ec3.page.soulStone_4.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.soulStone_5")
						.setText(I18n.translateToLocal("ec3.page.soulStone_5.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.soulStone_6")
						.setText(I18n.translateToLocal("ec3.page.soulStone_6.txt"))
						)
				)
		.apendDiscovery(
				...
				.apendPage(next("decorations").setText(I18n.translateToLocal("ec3.page.decorations_0.txt")))
		...
		.apendDiscovery(
				new DiscoveryEntry("ec3.disc.crystalLamp")
				...
				.apendPage(next("crystalLamp").setText(I18n.translateToLocal("ec3.page.crystalLamp_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("overworld").setText(I18n.translateToLocal("ec3.page.overworld_0.txt")))
				.apendPage(next("overworld").setText(I18n.translateToLocal("ec3.page.overworld_1.txt")))
	...
	public static void registerMruCategory()
	{
		...
		.apendDiscovery(
				...
				.apendPage(
						...
						.setText(I18n.translateToLocal("ec3.page.boundGem_0.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.boundGem_1")
						.setText(I18n.translateToLocal("ec3.page.boundGem_1.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.boundGem_2")
						.setText(I18n.translateToLocal("ec3.page.boundGem_2.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.boundGem_3")
						.setText(I18n.translateToLocal("ec3.page.boundGem_3.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.boundGem_4")
						.setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.bound_gem), 2))
						.setText(I18n.translateToLocal("ec3.page.boundGem_4.txt"))
						)
				)
		.apendDiscovery(
				...
				.apendPage(
						...
						.setText(I18n.translateToLocal("ec3.page.matrixDestructor_0.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.matrixDestructor_1")
						.setText(I18n.translateToLocal("ec3.page.matrixDestructor_1.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.matrixDestructor_2")
						.setText(I18n.translateToLocal("ec3.page.matrixDestructor_2.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.matrixDestructor_3")
						.setText(I18n.translateToLocal("ec3.page.matrixDestructor_3.txt"))
		...
		.apendDiscovery(
				...
				.apendPage(
						...
						.setText(I18n.translateToLocal("ec3.page.radiatingChamber_0.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.radiatingChamber_1")
						.setText(I18n.translateToLocal("ec3.page.radiatingChamber_1.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.radiatingChamber_2")
						.setText(I18n.translateToLocal("ec3.page.radiatingChamber_2.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.radiatingChamber_3")
						.setText(I18n.translateToLocal("ec3.page.radiatingChamber_3.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.radiatingChamber_4")
						.setText(I18n.translateToLocal("ec3.page.radiatingChamber_4.txt"))
						)
				.apendPage(
		...
		.apendDiscovery(
				...
				.apendPage(
						...
						.setText(I18n.translateToLocal("ec3.page.miscRadiation_0.txt"))
						)
				.apendPage(
		...
		.apendDiscovery(
				...
				.apendPage(
						...
						.setText(I18n.translateToLocal("ec3.page.magicianTable_0.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.magicianTable_1")
						.setText(I18n.translateToLocal("ec3.page.magicianTable_1.txt"))
						)
				.apendPage(
						new PageEntry("ec3.page.magicianTable_2")
						.setText(I18n.translateToLocal("ec3.page.magicianTable_2.txt"))
						)
				.apendPage(
				...
				.apendPage(
						...
						.setDisplayStacks(ec3.api.MagicianTableUpgrades.upgradeStacks.toArray(new ItemStack[ec3.api.MagicianTableUpgrades.upgradeStacks.size()]))
						.setText(I18n.translateToLocal("ec3.page.magicianTable_4.txt"))
						)
				)
		.apendDiscovery(
				...
				.apendPage(
						next("magicianCrafts")
						.setText(I18n.translateToLocal("ec3.page.magicianCrafts_0.txt"))
						)
		...
		.apendDiscovery(
				...
				.apendPage(next("paleItems").setText(I18n.translateToLocal("ec3.page.paleItems_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("magicMonocle").setText(I18n.translateToLocal("ec3.page.magicMonocle_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("mrucumover2").setText(I18n.translateToLocal("ec3.page.mrucumover2_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("mrucuec").setText(I18n.translateToLocal("ec3.page.mrucuec_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("mrucuec.state").setText(I18n.translateToLocal("ec3.page.mrucuec.state_0.txt")))
				.apendPage(next("mrucuec.state").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.ecStateChecker), 2)))
				.apendPage(next("mrucuec.state").setText(I18n.translateToLocal("ec3.page.mrucuec.state_2.txt")))
				)
		.apendDiscovery(
				...
				.apendPage(next("mrucuec.in").setText(I18n.translateToLocal("ec3.page.mrucuec.in_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("mrucuec.out").setText(I18n.translateToLocal("ec3.page.mrucuec.out_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("mrucuec.storage").setText(I18n.translateToLocal("ec3.page.mrucuec.storage_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("mrucuec.balancer").setText(I18n.translateToLocal("ec3.page.mrucuec.balancer_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("mrucuec.redstone").setText(I18n.translateToLocal("ec3.page.mrucuec.redstone_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("naturalFurnace").setText(I18n.translateToLocal("ec3.page.naturalFurnace_0.txt")))
				.apendPage(next("naturalFurnace").setText(I18n.translateToLocal("ec3.page.naturalFurnace_1.txt")).setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.naturalFurnace), 2)))
				)
		.apendDiscovery(
				...
				.apendPage(next("heatGenerator").setText(I18n.translateToLocal("ec3.page.heatGenerator_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("magicalMirrors").setText(I18n.translateToLocal("ec3.page.magicalMirrors_0.txt")))
				.apendPage(next("magicalMirrors").setText(I18n.translateToLocal("ec3.page.magicalMirrors_1.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("corruptionCleaner").setText(I18n.translateToLocal("ec3.page.corruptionCleaner_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("rayTower").setText(I18n.translateToLocal("ec3.page.rayTower_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("book_t2").setText(I18n.translateToLocal("ec3.page.book_t2_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("magicalActivator").setText(I18n.translateToLocal("ec3.page.magicalActivator_0.txt")))
				.apendPage(next("magicalActivator").setText(I18n.translateToLocal("ec3.page.magicalActivator_1.txt")))
				.apendPage(next("magicalActivator").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.rightClicker,1,0), 2)))
				.apendPage(next("magicalActivator").setText(I18n.translateToLocal("ec3.page.magicalActivator_2.txt")))
				.apendPage(next("magicalActivator").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.rightClicker,1,1), 3)))
				.apendPage(next("magicalActivator").setText(I18n.translateToLocal("ec3.page.magicalActivator_3.txt")))
				...
				.apendPage(next("magicalActivator").setText(I18n.translateToLocal("ec3.page.magicalActivator_4.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("redstoneTransmitter").setText(I18n.translateToLocal("ec3.page.redstoneTransmitter_0.txt")))
				.apendPage(next("redstoneTransmitter").setText(I18n.translateToLocal("ec3.page.redstoneTransmitter_1.txt")))
				.apendPage(next("redstoneTransmitter").setText(I18n.translateToLocal("ec3.page.redstoneTransmitter_2.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("magicalHopper").setText(I18n.translateToLocal("ec3.page.magicalHopper_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("metadataManager").setText(I18n.translateToLocal("ec3.page.metadataManager_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("blockBreaker").setText(I18n.translateToLocal("ec3.page.blockBreaker_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("weaponMaker").setText(I18n.translateToLocal("ec3.page.weaponMaker_0.txt")))
				.apendPage(next("weaponMaker").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.weaponMaker), 2)))
				.apendPage(next("weaponMaker").setText(I18n.translateToLocal("ec3.page.weaponMaker_1.txt")))
				.apendPage(next("weaponMaker").setText(I18n.translateToLocal("ec3.page.weaponMaker_2.txt")).setDisplayStacks(pistol))
				.apendPage(next("weaponMaker").setText(I18n.translateToLocal("ec3.page.weaponMaker_3.txt")).setDisplayStacks(rifle))
				.apendPage(next("weaponMaker").setText(I18n.translateToLocal("ec3.page.weaponMaker_4.txt")).setDisplayStacks(sniper))
				.apendPage(next("weaponMaker").setText(I18n.translateToLocal("ec3.page.weaponMaker_5.txt")).setDisplayStacks(gatling))
				.apendPage(next("weaponMaker").setText(I18n.translateToLocal("ec3.page.weaponMaker_6.txt")))
				.apendPage(next("weaponMaker").setText(I18n.translateToLocal("ec3.page.weaponMaker_7.txt")).setDisplayStacks(new ItemStack(ItemsCore.genericItem,1,5),new ItemStack(ItemsCore.genericItem,1,39),new ItemStack(ItemsCore.genericItem,1,50),new ItemStack(ItemsCore.genericItem,1,35),new ItemStack(ItemsCore.genericItem,1,52)))
				.apendPage(next("weaponMaker").setText(I18n.translateToLocal("ec3.page.weaponMaker_8.txt")))
				.apendPage(next("weaponMaker").setText(I18n.translateToLocal("ec3.page.weaponMaker_9.txt")))
				.apendPage(next("weaponMaker").setText(I18n.translateToLocal("ec3.page.weaponMaker_10.txt")))
				.apendPage(next("weaponMaker").setText(I18n.translateToLocal("ec3.page.weaponMaker_11.txt")))
				.apendPage(next("weaponMaker").setText(I18n.translateToLocal("ec3.page.weaponMaker_12.txt")))
				.apendPage(next("weaponMaker").setText(I18n.translateToLocal("ec3.page.weaponMaker_13.txt")))
				.apendPage(next("weaponMaker").setText(I18n.translateToLocal("ec3.page.weaponMaker_14.txt")))
				)
		.apendDiscovery(
				...
				.apendPage(next("magmaticFurnace").setText(I18n.translateToLocal("ec3.page.magmaticFurnace_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("magicalChest").setText(I18n.translateToLocal("ec3.page.magicalChest_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("replanter").setText(I18n.translateToLocal("ec3.page.replanter_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("itemShuffler").setText(I18n.translateToLocal("ec3.page.itemShuffler_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("crafter").setText(I18n.translateToLocal("ec3.page.crafter_0.txt")))
				.apendPage(next("crafter").setText(I18n.translateToLocal("ec3.page.crafter_1.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("breeder").setText(I18n.translateToLocal("ec3.page.breeder_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("shearingStation").setText(I18n.translateToLocal("ec3.page.shearingStation_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("separator").setText(I18n.translateToLocal("ec3.page.separator_0.txt")))
				.apendPage(next("separator").setText(I18n.translateToLocal("ec3.page.separator_1.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("advBreaker").setText(I18n.translateToLocal("ec3.page.advBreaker_0.txt")))
				.apendPage(next("advBreaker").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.advBreaker,1,0), 2)))
				.apendPage(next("advBreaker").setText(I18n.translateToLocal("ec3.page.advBreaker_1.txt")))
				.apendPage(next("advBreaker").setText(I18n.translateToLocal("ec3.page.advBreaker_2.txt")))
				.apendPage(next("advBreaker").setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.filter,1,0), 2)))
				.apendPage(next("advBreaker").setText(I18n.translateToLocal("ec3.page.advBreaker_3.txt")))
				.apendPage(next("advBreaker").setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.filter,1,2), 2)))
				.apendPage(next("advBreaker").setText(I18n.translateToLocal("ec3.page.advBreaker_4.txt")))
		...
		.apendDiscovery(new DiscoveryEntry("ec3.disc.mimic")
				.setDisplayStack(new ItemStack(BlocksCore.mimic,1,0))
				.setReferal(new ItemStack(BlocksCore.mimic,1,0))
				.apendPage(next("mimic").setText(I18n.translateToLocal("ec3.page.mimic_0.txt")))
	...
	public static void registerEngineersCategory() {
		...
		.apendDiscovery(
				...
				.apendPage(next("crystals").setText(I18n.translateToLocal("ec3.page.crystals_0.txt")))
				.apendPage(next("crystals").setText(I18n.translateToLocal("ec3.page.crystals_1.txt")))
				.apendPage(next("crystals").setDisplayStacks(crystal).setText(I18n.translateToLocal("ec3.page.crystals_2.txt")))
				.apendPage(next("crystals").setText(I18n.translateToLocal("ec3.page.crystals_3.txt")))
				.apendPage(next("crystals").setText(I18n.translateToLocal("ec3.page.crystals_4.txt")))
				.apendPage(next("crystals").setText(I18n.translateToLocal("ec3.page.crystals_5.txt")))
				.apendPage(next("crystals").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.crystalFormer), 2)))
				.apendPage(next("crystals").setText(I18n.translateToLocal("ec3.page.crystals_7.txt")))
				.apendPage(next("crystals").setText(I18n.translateToLocal("ec3.page.crystals_8.txt")))
				.apendPage(next("crystals").setText(I18n.translateToLocal("ec3.page.crystals_9.txt")))
				.apendPage(next("crystals").setText(I18n.translateToLocal("ec3.page.crystals_10.txt")))
				.apendPage(next("crystals").setText(I18n.translateToLocal("ec3.page.crystals_11.txt")))
				.apendPage(next("crystals").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.crystalController), 2)))
				.apendPage(next("crystals").setText(I18n.translateToLocal("ec3.page.crystals_13.txt")))
				.apendPage(next("crystals").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.crystalExtractor), 2)))
				.apendPage(next("crystals").setText(I18n.translateToLocal("ec3.page.crystals_15.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("matrixSwitch").setText(I18n.translateToLocal("ec3.page.matrixSwitch_0.txt")))
				.apendPage(next("matrixSwitch").setText(I18n.translateToLocal("ec3.page.matrixSwitch_1.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("enderGen").setText(I18n.translateToLocal("ec3.page.enderGen_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("coldDistillator").setText(I18n.translateToLocal("ec3.page.coldDistillator_0.txt")))
				.apendPage(next("coldDistillator").setText(I18n.translateToLocal("ec3.page.coldDistillator_1.txt")))
				.apendPage(next("coldDistillator").setText(I18n.translateToLocal("ec3.page.coldDistillator_2.txt")))
				.apendPage(next("coldDistillator").setText(I18n.translateToLocal("ec3.page.coldDistillator_3.txt")).setDisplayStacks(new ItemStack(Blocks.SNOW_LAYER)))
				.apendPage(next("coldDistillator").setText(I18n.translateToLocal("ec3.page.coldDistillator_4.txt")).setDisplayStacks(new ItemStack(Blocks.SNOW)))
				.apendPage(next("coldDistillator").setText(I18n.translateToLocal("ec3.page.coldDistillator_5.txt")).setDisplayStacks(new ItemStack(Blocks.ICE)))
				.apendPage(next("coldDistillator").setText(I18n.translateToLocal("ec3.page.coldDistillator_6.txt")).setDisplayStacks(new ItemStack(Blocks.PACKED_ICE)))
				.apendPage(next("coldDistillator").setText(I18n.translateToLocal("ec3.page.coldDistillator_7.txt")).setDisplayStacks(new ItemStack(BlocksCore.coldStone)))
		...
		.apendDiscovery(
				...
				.apendPage(next("solarAbsorber").setText(I18n.translateToLocal("ec3.page.solarAbsorber_0.txt")))
				.apendPage(next("solarAbsorber").setText(I18n.translateToLocal("ec3.page.solarAbsorber_1.txt")))
				.apendPage(next("solarAbsorber").setText(I18n.translateToLocal("ec3.page.solarAbsorber_2.txt")))
				...
				.apendPage(next("solarAbsorber").setText(I18n.translateToLocal("ec3.page.solarAbsorber_5.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("moonWell").setText(I18n.translateToLocal("ec3.page.moonWell_0.txt")))
				.apendPage(next("moonWell").setText(I18n.translateToLocal("ec3.page.moonWell_1.txt")))
				.apendPage(next("moonWell").setText(I18n.translateToLocal("ec3.page.moonWell_2.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("reactor").setText(I18n.translateToLocal("ec3.page.reactor_0.txt")))
				.apendPage(next("reactor").setImg(new ResourceLocation("essentialcraft","textures/special/bookIcons/reactor.png")))
				.apendPage(next("reactor").setText(I18n.translateToLocal("ec3.page.reactor_2.txt")))
				...
				.apendPage(next("reactor").setText(I18n.translateToLocal("ec3.page.reactor_8.txt")))
				)
		.apendDiscovery(
				...
				.apendPage(next("soulStorage").setText(I18n.translateToLocal("ec3.page.soulStorage_0.txt")))
				.apendPage(next("soulStorage").setText(I18n.translateToLocal("ec3.page.soulStorage_1.txt")).setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.storage,1,0), 6)))
				.apendPage(next("soulStorage").setText(I18n.translateToLocal("ec3.page.soulStorage_2.txt")).setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.storage,1,1), 6)))
				.apendPage(next("soulStorage").setText(I18n.translateToLocal("ec3.page.soulStorage_3.txt")).setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.storage,1,2), 6)))
				.apendPage(next("soulStorage").setText(I18n.translateToLocal("ec3.page.soulStorage_4.txt")).setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.storage,1,3), 6)))
				.apendPage(next("soulStorage").setText(I18n.translateToLocal("ec3.page.soulStorage_5.txt")).setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.storage,1,4), 6)))
				.apendPage(next("soulStorage").setText(I18n.translateToLocal("ec3.page.soulStorage_6.txt")).setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.chargingChamber,1,0), 2)))
				)
		.apendDiscovery(
				...
				.apendPage(next("magicalDigger").setText(I18n.translateToLocal("ec3.page.magicalDigger_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("magicalLantern").setText(I18n.translateToLocal("ec3.page.magicalLantern_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("magnetizingStaff").setText(I18n.translateToLocal("ec3.page.magnetizingStaff_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("spawnerCollector").setText(I18n.translateToLocal("ec3.page.spawnerCollector_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("lifeStaff").setText(I18n.translateToLocal("ec3.page.lifeStaff_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("holyMace").setText(I18n.translateToLocal("ec3.page.holyMace_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("emeraldHeart").setText(I18n.translateToLocal("ec3.page.emeraldHeart_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("magicalWings").setText(I18n.translateToLocal("ec3.page.magicalWings_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("magicalPorkchop").setText(I18n.translateToLocal("ec3.page.magicalPorkchop_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("magicalWater").setText(I18n.translateToLocal("ec3.page.magicalWater_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("magicalShield").setText(I18n.translateToLocal("ec3.page.magicalShield_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("biomeWand").setText(I18n.translateToLocal("ec3.page.biomeWand_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("chaosFork").setText(I18n.translateToLocal("ec3.page.chaosFork_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("frozenMace").setText(I18n.translateToLocal("ec3.page.frozenMace_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("magmaticStaff").setText(I18n.translateToLocal("ec3.page.magmaticStaff_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("mhs").setText(I18n.translateToLocal("ec3.page.mhs_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("elementalCharms").setText(I18n.translateToLocal("ec3.page.elementalCharms_0.txt")))
				.apendPage(next("elementalCharms").setText(I18n.translateToLocal("ec3.page.elementalCharms_1.txt")).setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.charm,1,0), 2)))
				.apendPage(next("elementalCharms").setText(I18n.translateToLocal("ec3.page.elementalCharms_2.txt")).setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.charm,1,1), 2)))
				.apendPage(next("elementalCharms").setText(I18n.translateToLocal("ec3.page.elementalCharms_3.txt")).setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.charm,1,2), 2)))
				.apendPage(next("elementalCharms").setText(I18n.translateToLocal("ec3.page.elementalCharms_4.txt")).setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.charm,1,3), 2)))
				.apendPage(next("elementalCharms").setText(I18n.translateToLocal("ec3.page.elementalCharms_5.txt")).setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.charm,1,4), 2)))
				.apendPage(next("elementalCharms").setText(I18n.translateToLocal("ec3.page.elementalCharms_6.txt")).setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.charm,1,5), 2)))
				.apendPage(next("elementalCharms").setText(I18n.translateToLocal("ec3.page.elementalCharms_7.txt")).setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.charm,1,6), 2)))
				.apendPage(next("elementalCharms").setText(I18n.translateToLocal("ec3.page.elementalCharms_8.txt")).setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.charm,1,7), 2)))
				.apendPage(next("elementalCharms").setText(I18n.translateToLocal("ec3.page.elementalCharms_9.txt")).setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.charm,1,8), 2)))
				.apendPage(next("elementalCharms").setText(I18n.translateToLocal("ec3.page.elementalCharms_10.txt")).setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.charm,1,9), 2)))
				)
		.apendDiscovery(
				...
				.apendPage(next("mruCoil").setText(I18n.translateToLocal("ec3.page.mruCoil_0.txt")))
				...
				.apendPage(next("mruCoil").setText(I18n.translateToLocal("ec3.page.mruCoil_4.txt")))
				.apendPage(next("mruCoil").setText(I18n.translateToLocal("ec3.page.mruCoil_5.txt")))
				.apendPage(next("mruCoil").setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.playerList,1,0), 2)))
				.apendPage(next("mruCoil").setText(I18n.translateToLocal("ec3.page.mruCoil_7.txt")))
				)
		.apendDiscovery(
				...
				.apendPage(next("potionSpreader").setText(I18n.translateToLocal("ec3.page.potionSpreader_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("magicalEnchanter").setText(I18n.translateToLocal("ec3.page.magicalEnchanter_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("monsterHolder").setText(I18n.translateToLocal("ec3.page.monsterHolder_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("magicalJukebox").setText(I18n.translateToLocal("ec3.page.magicalJukebox_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("magicalRepairer").setText(I18n.translateToLocal("ec3.page.magicalRepairer_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("monsterDuplicator").setText(I18n.translateToLocal("ec3.page.monsterDuplicator_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("magmaticSmeltery").setText(I18n.translateToLocal("ec3.page.magmaticSmeltery_0.txt")))
				.apendPage(next("magmaticSmeltery").setImg(new ResourceLocation("essentialcraft","textures/special/bookIcons/smeltery.png")))
				.apendPage(next("magmaticSmeltery").setText(I18n.translateToLocal("ec3.page.magmaticSmeltery_2.txt")))
				.apendPage(next("magmaticSmeltery").setText(I18n.translateToLocal("ec3.page.magmaticSmeltery_3.txt")))
				.apendPage(next("magmaticSmeltery").setText(I18n.translateToLocal("ec3.page.magmaticSmeltery_4.txt")))
				.apendPage(next("magmaticSmeltery").setText(I18n.translateToLocal("ec3.page.magmaticSmeltery_5.txt")))
				.apendPage(next("magmaticSmeltery").setText(I18n.translateToLocal("ec3.page.magmaticSmeltery_6.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("magicalQuarry").setText(I18n.translateToLocal("ec3.page.magicalQuarry_0.txt")))
				.apendPage(next("magicalQuarry").setText(I18n.translateToLocal("ec3.page.magicalQuarry_1.txt")))
				.apendPage(next("magicalQuarry").setText(I18n.translateToLocal("ec3.page.magicalQuarry_2.txt")))
				.apendPage(next("magicalQuarry").setText(I18n.translateToLocal("ec3.page.magicalQuarry_3.txt")))
				.apendPage(next("magicalQuarry").setText(I18n.translateToLocal("ec3.page.magicalQuarry_4.txt")).setRecipe(ECUtils.findRecipeByIS(generic(18), 2)))
				.apendPage(next("magicalQuarry").setText(I18n.translateToLocal("ec3.page.magicalQuarry_5.txt")).setRecipe(ECUtils.findRecipeByIS(generic(19), 2)))
				.apendPage(next("magicalQuarry").setText(I18n.translateToLocal("ec3.page.magicalQuarry_6.txt")).setRecipe(ECUtils.findRecipeByIS(generic(17), 2)))
				.apendPage(next("magicalQuarry").setText(I18n.translateToLocal("ec3.page.magicalQuarry_7.txt")).setRecipe(ECUtils.findRecipeByIS(generic(80), 2)))
				.apendPage(next("magicalQuarry").setText(I18n.translateToLocal("ec3.page.magicalQuarry_8.txt")).setRecipe(ECUtils.findRecipeByIS(generic(81), 2)))
				.apendPage(next("magicalQuarry").setText(I18n.translateToLocal("ec3.page.magicalQuarry_9.txt")).setRecipe(ECUtils.findRecipeByIS(generic(78), 2)))
				.apendPage(next("magicalQuarry").setText(I18n.translateToLocal("ec3.page.magicalQuarry_10.txt")).setRecipe(ECUtils.findRecipeByIS(generic(77), 2)))
		...
		.apendDiscovery(
				...
				.apendPage(next("hoanna").setText(I18n.translateToLocal("ec3.page.hoanna_0.txt")))
				.apendPage(next("hoanna").setText(I18n.translateToLocal("ec3.page.hoanna_1.txt")))
				.apendPage(next("hoanna").setText(I18n.translateToLocal("ec3.page.hoanna_2.txt")))
				.apendPage(next("hoanna").setText(I18n.translateToLocal("ec3.page.hoanna_3.txt")))
				.apendPage(next("hoanna").setText(I18n.translateToLocal("ec3.page.hoanna_4.txt")).setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.windTablet,1,0), 2)))
				.apendPage(next("hoanna").setText(I18n.translateToLocal("ec3.page.hoanna_5.txt")))
				.apendPage(next("hoanna").setText(I18n.translateToLocal("ec3.page.hoanna_6.txt")))
				.apendPage(next("hoanna").setText(I18n.translateToLocal("ec3.page.hoanna_7.txt")))
				.apendPage(next("hoanna").setText(I18n.translateToLocal("ec3.page.hoanna_8.txt")))
				.apendPage(next("hoanna").setText(I18n.translateToLocal("ec3.page.hoanna_9.txt")))
	...
	public static void registerHoannaCategory()
	{
		...
		.apendDiscovery(
				...
				.apendPage(next("radiation").setText(I18n.translateToLocal("ec3.page.radiation_0.txt")))
				.apendPage(next("radiation").setText(I18n.translateToLocal("ec3.page.radiation_1.txt")))
				.apendPage(next("radiation").setText(I18n.translateToLocal("ec3.page.radiation_2.txt")))
				.apendPage(next("radiation").setText(I18n.translateToLocal("ec3.page.radiation_3.txt")))
				.apendPage(next("radiation").setText(I18n.translateToLocal("ec3.page.radiation_4.txt")))
				.apendPage(next("radiation").setText(I18n.translateToLocal("ec3.page.radiation_5.txt")))
				.apendPage(next("radiation").setText(I18n.translateToLocal("ec3.page.radiation_6.txt")))
				.apendPage(next("radiation").setText(I18n.translateToLocal("ec3.page.radiation_7.txt")))
				)
		.apendDiscovery(
				...
				.apendPage(next("loot").setText(I18n.translateToLocal("ec3.page.loot_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("voidStone").setText(I18n.translateToLocal("ec3.page.voidStone_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("voidArmor").setText(I18n.translateToLocal("ec3.page.voidArmor_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("magicalTeleporter").setText(I18n.translateToLocal("ec3.page.magicalTeleporter_0.txt")))
				.apendPage(next("magicalTeleporter").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.magicalTeleporter), 2)))
				.apendPage(next("magicalTeleporter").setText(I18n.translateToLocal("ec3.page.magicalTeleporter_2.txt")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.magicalTeleporter),
				...
				.apendPage(next("magicalTeleporter").setText(I18n.translateToLocal("ec3.page.magicalTeleporter_3.txt")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.magicalTeleporter),
						new StructureBlock(BlocksCore.voidStone, 0, -2, 0, 1),
						new StructureBlock(BlocksCore.voidStone, 0, -2, 0, -1),
						new StructureBlock(BlocksCore.voidStone, 0, 2, 0, 1),
						new StructureBlock(BlocksCore.voidStone, 0, 2, 0, -1),
				...
				.apendPage(next("magicalTeleporter").setText(I18n.translateToLocal("ec3.page.magicalTeleporter_4.txt")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.magicalTeleporter),
						new StructureBlock(BlocksCore.voidStone, 0, -2, 0, 1),
						new StructureBlock(BlocksCore.voidStone, 0, -2, 0, -1),
						new StructureBlock(BlocksCore.voidStone, 0, 2, 0, 1),
						new StructureBlock(BlocksCore.voidStone, 0, 2, 0, -1),
		...
		.apendDiscovery(
				...
				.apendPage(next("magicalFurnace").setText(I18n.translateToLocal("ec3.page.magicalFurnace_0.txt")))
				.apendPage(next("magicalFurnace").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.magicalFurnace), 2)))
				.apendPage(next("magicalFurnace").setText(I18n.translateToLocal("ec3.page.magicalFurnace_2.txt")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.magicalFurnace),
						new StructureBlock(BlocksCore.voidStone, 0, -2, 0, 2),
						new StructureBlock(BlocksCore.voidStone, 0, -1, 0, 2),
				...
				.apendPage(next("magicalFurnace").setText(I18n.translateToLocal("ec3.page.magicalFurnace_3.txt")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.magicalFurnace),
						new StructureBlock(BlocksCore.voidStone, 0, -2, 0, -2),
						new StructureBlock(BlocksCore.voidStone, 0, -2, 0, 2),
						new StructureBlock(BlocksCore.voidStone, 0, 2, 0, -2),
						new StructureBlock(BlocksCore.voidStone, 0, 2, 0, 2),
				...
				.apendPage(next("magicalFurnace").setText(I18n.translateToLocal("ec3.page.magicalFurnace_4.txt")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.magicalFurnace),
		...
		.apendDiscovery(
				...
				.apendPage(next("emberForge").setText(I18n.translateToLocal("ec3.page.emberForge_0.txt")))
				.apendPage(next("emberForge").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.emberForge), 2)))
				.apendPage(next("emberForge").setText(I18n.translateToLocal("ec3.page.emberForge_2.txt")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.emberForge),
						new StructureBlock(BlocksCore.voidStone, 0, -2, 0, 2),
						new StructureBlock(BlocksCore.voidStone, 0, -1, 0, 2),
						new StructureBlock(BlocksCore.voidStone, 0, 0, 0, 2),
						new StructureBlock(BlocksCore.voidStone, 0, 1, 0, 2),
				...
				.apendPage(next("emberForge").setText(I18n.translateToLocal("ec3.page.emberForge_3.txt")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.emberForge),
						new StructureBlock(BlocksCore.voidStone, 0, -2, 0, -2),
						new StructureBlock(BlocksCore.voidStone, 0, -2, 0, 2),
						new StructureBlock(BlocksCore.voidStone, 0, 2, 0, -2),
						new StructureBlock(BlocksCore.voidStone, 0, 2, 0, 2),
				...
				.apendPage(next("emberForge").setText(I18n.translateToLocal("ec3.page.emberForge_4.txt")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.emberForge),
		...
		/*
			.apendDiscovery(
					...
					.apendPage(next("mim").setText(I18n.translateToLocal("ec3.page.mim_0.txt")))
					.apendPage(next("mim").setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.filter,1,0), 2)))
					.apendPage(next("mim").setText(I18n.translateToLocal("ec3.page.mim_2.txt")))
					.apendPage(next("mim").setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.filter,1,1), 2)))
					.apendPage(next("mim").setText(I18n.translateToLocal("ec3.page.mim_4.txt")))
					...
					.apendPage(next("mim").setText(I18n.translateToLocal("ec3.page.mim_7.txt")))
					.apendPage(next("mim").setText(I18n.translateToLocal("ec3.page.mim_8.txt")))
					...
					.apendPage(next("mim").setText(I18n.translateToLocal("ec3.page.mim_11.txt")))
					.apendPage(next("mim").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.mim,1,0), 2)))
					.apendPage(next("mim").setText(I18n.translateToLocal("ec3.page.mim_13.txt")))
			)
		 */
		.apendDiscovery(
				...
				.apendPage(next("o8elisk").setText(I18n.translateToLocal("ec3.page.o8elisk_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("ultraHeat").setText(I18n.translateToLocal("ec3.page.ultraHeat_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("ultraFlower").setText(I18n.translateToLocal("ec3.page.ultraFlower_0.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("magicalBuilder").setText(I18n.translateToLocal("ec3.page.magicalBuilder_0.txt")))
				.apendPage(next("magicalBuilder").setText(I18n.translateToLocal("ec3.page.magicalBuilder_1.txt")))
				.apendPage(next("magicalBuilder").setText(I18n.translateToLocal("ec3.page.magicalBuilder_2.txt")))
				.apendPage(next("magicalBuilder").setText(I18n.translateToLocal("ec3.page.magicalBuilder_3.txt")))
				.apendPage(next("magicalBuilder").setText(I18n.translateToLocal("ec3.page.magicalBuilder_4.txt")))
				.apendPage(next("magicalBuilder").setText(I18n.translateToLocal("ec3.page.magicalBuilder_5.txt")))
		...
		.apendDiscovery(new DiscoveryEntry("hologram")
				...
				.apendPage(next("hologram").setText(I18n.translateToLocal("ec3.page.hologram_0.txt")))
				.apendPage(next("hologram").setText(I18n.translateToLocal("ec3.page.hologram_1.txt")).setDisplayStacks(new ItemStack(ItemsCore.genericItem,1,70),new ItemStack(ItemsCore.genericItem,1,71),new ItemStack(ItemsCore.genericItem,1,72),new ItemStack(ItemsCore.genericItem,1,73)))
				.apendPage(next("hologram").setText(I18n.translateToLocal("ec3.page.hologram_2.txt")))
				.apendPage(next("hologram").setText(I18n.translateToLocal("ec3.page.hologram_3.txt")).setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.holopad), 2)))
				)
		.apendDiscovery(new DiscoveryEntry("redSuit")
				...
				.apendPage(next("redSuit").setText(I18n.translateToLocal("ec3.page.redSuit_0.txt")))
				.apendPage(next("redSuit").setText(I18n.translateToLocal("ec3.page.redSuit_1.txt")))
				.apendPage(next("redSuit").setText(I18n.translateToLocal("ec3.page.redSuit_2.txt")))
				.apendPage(next("redSuit").setText(I18n.translateToLocal("ec3.page.redSuit_3.txt")))
				.apendPage(next("redSuit").setText(I18n.translateToLocal("ec3.page.redSuit_4.txt")))
				.apendPage(next("redSuit").setText(I18n.translateToLocal("ec3.page.redSuit_5.txt")))
				.apendPage(next("redSuit").setText(I18n.translateToLocal("ec3.page.redSuit_6.txt")))
				.apendPage(next("redSuit").setText(I18n.translateToLocal("ec3.page.redSuit_7.txt")))
				...
				.apendPage(next("redSuit").setText(I18n.translateToLocal("ec3.page.redSuit_?.txt")))
				)
		.apendDiscovery(
				...
				.apendPage(next("newMim").setText(I18n.translateToLocal("ec3.page.newMim_0.txt")))
				.apendPage(next("newMim").setText(I18n.translateToLocal("ec3.page.newMim_1.txt")))
				.apendPage(next("newMim").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.newMim), 2)))
				.apendPage(next("newMim").setText(I18n.translateToLocal("ec3.page.newMim_2.txt")))
				.apendPage(next("newMim").setText(I18n.translateToLocal("ec3.page.newMim_3.txt")))
				.apendPage(next("newMim").setText(I18n.translateToLocal("ec3.page.newMim_4.txt")))
				.apendPage(next("newMim").setText(I18n.translateToLocal("ec3.page.newMim_5.txt")))
				.apendPage(next("newMim").setText(I18n.translateToLocal("ec3.page.newMim_6.txt")))
				.apendPage(next("newMim").setText(I18n.translateToLocal("ec3.page.newMim_7.txt")))
				...
				.apendPage(next("newMim").setText(I18n.translateToLocal("ec3.page.newMim_8.txt")))
		...
		.apendDiscovery(new DiscoveryEntry("newMimInv")
				...
				.apendPage(next("newMimInv").setText(I18n.translateToLocal("ec3.page.newMimInv_0.txt")))
				.apendPage(next("newMimInv").setText(I18n.translateToLocal("ec3.page.newMimInv_1.txt")))
				.apendPage(next("newMimInv").setText(I18n.translateToLocal("ec3.page.newMimInv_2.txt")))
		...
		.apendDiscovery(new DiscoveryEntry("newMimCraft")
				...
				.apendPage(next("newMimCraft").setText(I18n.translateToLocal("ec3.page.newMimCraft_0.txt")))
		...
		.apendDiscovery(new DiscoveryEntry("newMimScreen")
				...
				.apendPage(next("newMimScreen").setText(I18n.translateToLocal("ec3.page.newMimScreen_0.txt")))
				.apendPage(next("newMimScreen").setText(I18n.translateToLocal("ec3.page.newMimScreen_1.txt")))
				.apendPage(next("newMimScreen").setText(I18n.translateToLocal("ec3.page.newMimScreen_2.txt")))
	...
	public static void registerEnderCategory()
	{
		...
		.apendDiscovery(
				...
				.apendPage(next("enderstar").setText(I18n.translateToLocal("ec3.page.enderstar_0.txt")))
				.apendPage(next("enderstar").setText(I18n.translateToLocal("ec3.page.enderstar_1.txt")))
				.apendPage(next("enderstar").setText(I18n.translateToLocal("ec3.page.enderstar_2.txt")))
				)
		.apendDiscovery(
				...
				.apendPage(next("mithriline").setText(I18n.translateToLocal("ec3.page.mithriline_0.txt")))
				.apendPage(next("mithriline").setText(I18n.translateToLocal("ec3.page.mithriline_1.txt")).setDisplayStacks(new ItemStack(BlocksCore.oreMithriline,1,0),new ItemStack(ItemsCore.genericItem,1,51)))
				...
				.apendPage(next("mithriline").setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.genericItem,1,50), 2)))
				.apendPage(next("mithriline").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.invertedBlock,1,0), 2)).setText(I18n.translateToLocal("ec3.page.mithriline_2.txt")))
				.apendPage(next("mithriline").setText(I18n.translateToLocal("ec3.page.mithriline_3.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("mithrilineFurnace").setText(I18n.translateToLocal("ec3.page.mithrilineFurnace_0.txt")))
				.apendPage(next("mithrilineFurnace").setText(I18n.translateToLocal("ec3.page.mithrilineFurnace_1.txt")))
				.apendPage(next("mithrilineFurnace").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.mithrilineFurnace,1,0), 2)))
				.apendPage(next("mithrilineFurnace").setText(I18n.translateToLocal("ec3.txt.layer_-1")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.mithrilineFurnace),
				...
				.apendPage(next("mithrilineFurnace").setText(I18n.translateToLocal("ec3.txt.layer_0")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.mithrilineFurnace),
				...
				.apendPage(next("mithrilineFurnace").setText(I18n.translateToLocal("ec3.txt.layer_1")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.mithrilineFurnace),
						new StructureBlock(BlocksCore.invertedBlock, 0, 2, 0, 2),
						new StructureBlock(BlocksCore.invertedBlock, 0, 2, 0, -2),
						new StructureBlock(BlocksCore.invertedBlock, 0, -2, 0, 2),
						new StructureBlock(BlocksCore.invertedBlock, 0, -2, 0, -2)
						)))
				.apendPage(next("mithrilineFurnace").setText(I18n.translateToLocal("ec3.txt.layer_2")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.mithrilineFurnace),
		...
		.apendDiscovery(
				...
				.apendPage(next("windRune").setText(I18n.translateToLocal("ec3.page.windRune_0.txt")))
				.apendPage(next("windRune").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.windRune,1,0), 2)))
				.apendPage(next("windRune").setText(I18n.translateToLocal("ec3.txt.layer_-1")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.windRune),
				...
				.apendPage(next("windRune").setText(I18n.translateToLocal("ec3.txt.layer_0")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.windRune),
				...
				.apendPage(next("windRune").setText(I18n.translateToLocal("ec3.txt.layer_1")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.windRune),
						new StructureBlock(BlocksCore.invertedBlock, 0, 1, 0, 1),
						new StructureBlock(BlocksCore.invertedBlock, 0, -1, 0, 1),
						new StructureBlock(BlocksCore.invertedBlock, 0, 1, 0, -1),
						new StructureBlock(BlocksCore.invertedBlock, 0, -1, 0, -1)
						)))
				.apendPage(next("windRune").setText(I18n.translateToLocal("ec3.txt.layer_2")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.windRune),
						new StructureBlock(BlocksCore.mithrilineCrystal, 0, 1, 0, 1),
						new StructureBlock(BlocksCore.mithrilineCrystal, 0, -1, 0, 1),
						new StructureBlock(BlocksCore.mithrilineCrystal, 0, 1, 0, -1),
						new StructureBlock(BlocksCore.mithrilineCrystal, 0, -1, 0, -1)
						)))
				.apendPage(next("windRune").setText(I18n.translateToLocal("ec3.page.windRune_1.txt")))
				.apendPage(next("windRune").setText(I18n.translateToLocal("ec3.page.windRune_2.txt")))
				.apendPage(next("windRune").setText(I18n.translateToLocal("ec3.page.windRune_3.txt")))
				.apendPage(next("windRune").setText(I18n.translateToLocal("ec3.page.windRune_4.txt")))
		...
		.apendDiscovery(
				...
				.apendPage(next("playerPentacle").setText(I18n.translateToLocal("ec3.page.playerPentacle_0.txt")))
				.apendPage(next("playerPentacle").setText(I18n.translateToLocal("ec3.page.playerPentacle_1.txt")))
				.apendPage(next("playerPentacle").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.playerPentacle), 2)))
				.apendPage(next("playerPentacle").setText(I18n.translateToLocal("ec3.txt.layer_-1")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.playerPentacle),
						new StructureBlock(BlocksCore.invertedBlock, 0, 1, 0, 0),
						new StructureBlock(BlocksCore.invertedBlock, 0, -1, 0, 0),
						new StructureBlock(BlocksCore.invertedBlock, 0, 0, 0, 1),
						new StructureBlock(BlocksCore.invertedBlock, 0, 0, 0, -1),
				...
				.apendPage(next("playerPentacle").setText(I18n.translateToLocal("ec3.txt.layer_0")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.playerPentacle),
				...
				.apendPage(next("playerPentacle").setText(I18n.translateToLocal("ec3.page.playerPentacle_2.txt")))
				.apendPage(next("playerPentacle").setText(I18n.translateToLocal("ec3.txt.layer_-1")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.playerPentacle),
						new StructureBlock(BlocksCore.invertedBlock, 0, 1, 0, 0),
						new StructureBlock(BlocksCore.invertedBlock, 0, -1, 0, 0),
						new StructureBlock(BlocksCore.invertedBlock, 0, 0, 0, 1),
				...
				.apendPage(next("playerPentacle").setText(I18n.translateToLocal("ec3.txt.layer_1")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.playerPentacle),
				...
				.apendPage(next("playerPentacle").setText(I18n.translateToLocal("ec3.page.playerPentacle_3.txt")))
				.apendPage(next("playerPentacle").setText(I18n.translateToLocal("ec3.txt.layer_-1")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.playerPentacle),
						new StructureBlock(BlocksCore.invertedBlock, 0, 1, 0, 0),
						new StructureBlock(BlocksCore.invertedBlock, 0, -1, 0, 0),
						new StructureBlock(BlocksCore.invertedBlock, 0, 0, 0, 1),
				...
				.apendPage(next("playerPentacle").setText(I18n.translateToLocal("ec3.txt.layer_2")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.playerPentacle),
				...
				.apendPage(next("playerPentacle").setText(I18n.translateToLocal("ec3.page.playerPentacle_4.txt")))
				.apendPage(next("playerPentacle").setText(I18n.translateToLocal("ec3.txt.layer_-1")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.playerPentacle),
						new StructureBlock(BlocksCore.invertedBlock, 0, 1, 0, 0),
						new StructureBlock(BlocksCore.invertedBlock, 0, -1, 0, 0),
						new StructureBlock(BlocksCore.invertedBlock, 0, 0, 0, 1),
				...
				.apendPage(next("playerPentacle").setText(I18n.translateToLocal("ec3.txt.layer_3")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.playerPentacle),
		...
		.apendDiscovery(
				...
				.apendPage(next("demonicPentacle").setText(I18n.translateToLocal("ec3.page.demonicPentacle_0.txt")))
				.apendPage(next("demonicPentacle").setText(I18n.translateToLocal("ec3.page.demonicPentacle_1.txt")))
				.apendPage(next("demonicPentacle").setText(I18n.translateToLocal("ec3.page.demonicPentacle_2.txt")))
				.apendPage(next("demonicPentacle").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.demonicPentacle), 2)))
				.apendPage(next("demonicPentacle").setText(I18n.translateToLocal("ec3.txt.layer_-1")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.demonicPentacle),
						new StructureBlock(BlocksCore.voidStone, 0, 0, 0, 0),
				...
				.apendPage(next("demonicPentacle").setText(I18n.translateToLocal("ec3.txt.layer_0")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.demonicPentacle),
				...
				.apendPage(next("demonicPentacle").setText(I18n.translateToLocal("ec3.txt.layer_1")).setRecipe(new StructureRecipe(new ItemStack(BlocksCore.demonicPentacle),
				...
				.apendPage(next("demonicPentacle").setText(I18n.translateToLocal("ec3.page.demonicPentacle_3.txt")).setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.soulScriber), 2)))
