	...
	public boolean hitEntity(ItemStack par1ItemStack, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase)
	{
		if(par3EntityLivingBase instanceof EntityPlayer) {
			...
			if((ECUtils.tryToDecreaseMRUInStorage((EntityPlayer) par3EntityLivingBase, -50) || this.setMRU(par1ItemStack, -50)))
			{
				...
				{
					EntityLightningBolt bold = new EntityLightningBolt(par2EntityLivingBase.worldObj, par2EntityLivingBase.posX, par2EntityLivingBase.posY, par2EntityLivingBase.posZ, false);
