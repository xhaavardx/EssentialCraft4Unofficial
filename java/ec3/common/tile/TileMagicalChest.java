...
public class TileMagicalChest extends TileEntity implements IInventory, ISidedInventory, ITickable {
	...
	public boolean isUseableByPlayer(EntityPlayer entityplayer) {
		return worldObj.getTileEntity(pos) == this && pos.distanceSqToCenter(entityplayer.posX, entityplayer.posY, entityplayer.posZ) <= 64D;
	}

	@Override
	public void openInventory(EntityPlayer p) {
		++numUsingPlayers;
		worldObj.addBlockEvent(pos, worldObj.getBlockState(pos).getBlock(), 1, numUsingPlayers);
	}
