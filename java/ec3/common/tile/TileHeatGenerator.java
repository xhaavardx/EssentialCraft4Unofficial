...
public class TileHeatGenerator extends TileMRUGeneric {
	...
	public void update() {
		...
		EssentialCraftCore.proxy.SmokeFX(pos.getX()+0.5F + MathUtils.randomFloat(worldObj.rand)*0.05F, pos.getY()+0.8F, pos.getZ()+0.5F + MathUtils.randomFloat(worldObj.rand)*0.05F, 0, 0, 0, 1);
	}
