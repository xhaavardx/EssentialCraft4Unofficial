...
public class WindRelations {
	...
	public static void playerTick(EntityPlayer player)
	{
		...
		if(!player.worldObj.isRemote && player.worldObj.rand.nextDouble() < (0.0002F)*mod)
		{
			...
			if(!elemental)
				player.addChatMessage(new TextComponentString(TextFormatting.DARK_AQUA+""+TextFormatting.ITALIC+"The wind timidly touches your hair..."));
			else
			{
				...
				if(rndID == 0)
				{
					player.addChatMessage(new TextComponentString(TextFormatting.DARK_AQUA+""+TextFormatting.ITALIC+"You feel a warm touch of the wind..."));
					player.addPotionEffect(new PotionEffect(MobEffects.STRENGTH,6*60*20,1,true,true));
				}
				//Water
				if(rndID == 1)
				{
					player.addChatMessage(new TextComponentString(TextFormatting.DARK_AQUA+""+TextFormatting.ITALIC+"You feel a chilling touch of the wind..."));
					player.addPotionEffect(new PotionEffect(MobEffects.REGENERATION,2*60*20,0,true,true));
				}
				//Earth
				if(rndID == 2)
				{
					player.addChatMessage(new TextComponentString(TextFormatting.DARK_AQUA+""+TextFormatting.ITALIC+"You feel a strong push of the wind..."));
					player.addPotionEffect(new PotionEffect(MobEffects.SATURATION,2*60*20,0,true,true));
				}
				//Air
				if(rndID == 2)
				{
					player.addChatMessage(new TextComponentString(TextFormatting.DARK_AQUA+""+TextFormatting.ITALIC+"You feel a strong blow of the wind..."));
		...
		if(!player.worldObj.isRemote && player.worldObj.rand.nextDouble() < 0.001F*mod)
		{
			...
			{
				player.addChatMessage(new TextComponentString(TextFormatting.DARK_AQUA+""+TextFormatting.ITALIC+"The wind pushes you in the back..."));
				increasePlayerWindRelations(player,1000);
