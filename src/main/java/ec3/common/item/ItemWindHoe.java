...
public class ItemWindHoe extends ItemHoe_Mod {
	...
	public boolean hitEntity(ItemStack weapon, EntityLivingBase attacked, EntityLivingBase attacker)
	{
		if(attacker instanceof EntityPlayer)
		{
			...
			if(!p.getEntityWorld().isRemote && currentTool != null && currentTool.getItem() instanceof ItemTool && ItemTool.class.cast(currentTool.getItem()).getToolMaterial() == ItemsCore.windElemental)
			{
