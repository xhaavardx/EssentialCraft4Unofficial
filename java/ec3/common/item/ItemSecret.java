...
public class ItemSecret extends Item implements IModelRegisterer {
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, EnumHand hand) {
		...
		case 0: {
			...
			Biome biome = wrld.getBiomeGenForCoords(new BlockPos(MathHelper.floor_double(player.posX), MathHelper.floor_double(player.posY), MathHelper.floor_double(player.posZ)));
			...
			if(canWork) {
				...
				if(wrld.isRemote) {
					player.addChatMessage(new TextComponentString(TextFormatting.WHITE+"You gase into the stars holding the ticket."));
					player.addChatMessage(new TextComponentString(TextFormatting.WHITE+"Suddenly a gust of wind swoops upon you."));
					player.addChatMessage(new TextComponentString(TextFormatting.WHITE+"You are immediately beeing attacked by lots of feels."));
					player.addChatMessage(new TextComponentString(TextFormatting.WHITE+"Strange, warm feels fall upon you."));
					player.addChatMessage(new TextComponentString(TextFormatting.WHITE+"You feel calm and relaxed."));
					player.addChatMessage(new TextComponentString(TextFormatting.WHITE+"A feeling falls upon you. You feel like you've just lived a whole another life."));
					player.addChatMessage(new TextComponentString(TextFormatting.WHITE+"You try to remember what happened, but memory lets you down."));
					player.addChatMessage(new TextComponentString(TextFormatting.WHITE+"You suddenly realise, that you no longer keep the ticket in your hand."));
					player.addChatMessage(new TextComponentString(TextFormatting.WHITE+"Instead a music disk is in your hand."));
					player.addChatMessage(new TextComponentString(TextFormatting.WHITE+"When you gaze to the disk, you begin to hear the song, written on it."));
					player.addChatMessage(new TextComponentString(TextFormatting.WHITE+"You start feeling really sad, like you've missed something very important to you."));
					player.addChatMessage(new TextComponentString(TextFormatting.WHITE+"You feel lonely, like missing another half of you."));
					player.addChatMessage(new TextComponentString(TextFormatting.WHITE+"After some time you calm down."));
				}
