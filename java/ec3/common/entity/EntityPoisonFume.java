...
public class EntityPoisonFume extends EntityMob {
	...
	public void onLivingUpdate()
	{
		...
		List<EntityPlayer> players = this.worldObj.<EntityPlayer>getEntitiesWithinAABB(EntityPlayer.class, new AxisAlignedBB(posX-1, posY-1, posZ-1, posX+1, posY+1, posZ+1).expand(6, 3, 6));
