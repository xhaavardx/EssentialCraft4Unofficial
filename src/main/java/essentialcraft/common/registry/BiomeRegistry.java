...
public class BiomeRegistry {
	...
	public static void register(IForgeRegistry<Biome> registry) {
		...
		BiomeDictionary.addTypes(chaosCorruption, Type.MAGICAL, Type.WASTELAND);
		BiomeDictionary.addTypes(frozenCorruption, Type.MAGICAL, Type.WASTELAND);
		BiomeDictionary.addTypes(shadowCorruption, Type.MAGICAL, Type.WASTELAND, Type.RARE);
		BiomeDictionary.addTypes(magicCorruption, Type.MAGICAL, Type.WASTELAND);
